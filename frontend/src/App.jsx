...
function App() {
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto selection:bg-blue-500/30">
      {/* Header */}
      <div className="text-center mb-12 animate-fade-in">
        <div className="inline-block mb-4 p-2 rounded-2xl bg-gradient-to-tr from-blue-500/20 to-purple-500/20 border border-white/10 backdrop-blur-md">
      ...
      {error && (
        <div className="glass-card mb-8 p-5 bg-rose-500/10 border-rose-500/30 text-rose-300 flex items-center gap-4 animate-fade-in shadow-[0_0_30px_rgba(225,29,72,0.1)]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 h-full">
           {apiResponse ? (
             ...
             <div className="h-full min-h-[400px] glass-card flex flex-col items-center justify-center text-slate-500 animate-slide-up" style={{ animationDelay: '0.1s' }}>
               <div className="p-6 rounded-full bg-slate-800/50 mb-6 shadow-inner">
